  ...
  return (
    <NGOGuard>
      <div className="flex flex-col flex-1">
        <Header
          title="Team"
          subtitle="Manage your NGO team members and their permissions"
        />
              ...
              <div className="space-y-4">
                ...
                <div>
                  <p className="text-xs font-medium text-gray-700 mb-2">
                    ...
                    <span className="text-gray-400 font-normal ml-1">
                      — customise what this member can do
                    </span>
                  </p>
                    ...
                    {PERMISSIONS.map((perm) => (
                      ...
                      >
                        <input
                          type="checkbox"
                          checked={
                            invite[perm.key as keyof InviteForm] as boolean
                          }
                          onChange={(e) =>
                            setInvite((f) => ({
                              ...f,
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="px-4 py-2 bg-brand-green text-white text-sm rounded-lg hover:bg-brand-green-dk disabled:opacity-50 transition-colors"
                  >
                ...
                {inviteMutation.isError && (
                  <p className="text-sm text-red-600">
                    Failed to send invitation. Make sure the user has a
                    FoodShare account first.
                  </p>
                )}
              </div>
            </div>
          ...
          {isLoading ? (
            ...
            <div className="bg-white rounded-xl border border-gray-100 p-8 text-center">
              ...
              <p className="text-xs text-gray-400 mt-1">
                Invite staff members to help manage your NGO
              </p>
            </div>
          ) : (
            <div className="space-y-3">
                          ...
                          >
                            <div
                              className={cn(
                                ...
                                member[perm.key as keyof NGOMember]
                                  ? "bg-brand-green"
                                  : "bg-gray-200",
                              )}
                            >
